...
const LandingDirectToShop = () => {
  return (
    <div class="snap-center">
      <section class="flex h-screen justify-center lg:h-auto dark:bg-walnut_brown-400">
              ...
              <For each={[...Array(6).keys()]}>
                {() => (
                  ...
                  >
                    ...
                    <h2 class="mt-2 font-bold dark:text-timberwolf-800">
                      Accountant
                    </h2>

                    <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600 dark:text-timberwolf">
